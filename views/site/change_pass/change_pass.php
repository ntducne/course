...
<script>
    ...
    function update_pass(){
        ...
        if(old_pass === ''){
            showSuccessToast('Cảnh báo','Chưa nhập mật khẩu cũ','error')
        }
        else if(old_pass.length < 6){
            showSuccessToast('Cảnh báo','Mật khẩu cũ chưa đủ 6 ký tự !','error')
        }
        else if(new_pass === '') {
            showSuccessToast('Cảnh báo','Chưa nhập mật khẩu mới','error')
        }
        else if(new_pass.length < 6) {
            showSuccessToast('Cảnh báo','Mật khẩu mới chưa đủ 6 ký tự !','error')
        }
        else if(comfirm_pass === '') {
            showSuccessToast('Cảnh báo','Chưa nhập lại mật khẩu mới !','error')
        }
        else if(comfirm_pass.length < 6) {
            showSuccessToast('Cảnh báo','Nhập lại mật khẩu mới chưa đủ 6 ký tự !','error')
        }
